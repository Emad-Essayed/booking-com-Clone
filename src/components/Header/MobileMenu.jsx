...
import links from "../../data/MobileMenu.json";
...
const AndroidIcon = () => {
  return (
    <SvgIcon
      ...
      focusable="false"
    >
      <path d="M18.001 12v8.25a2.25 2.25 0 0 1-2.25 2.25h-7.5a2.25 2.25 0 0 1-2.25-2.25V3.75a2.25 2.25 0 0 1 2.25-2.25h7.5a2.25 2.25 0 0 1 2.25 2.25V12zm1.5 0V3.75A3.75 3.75 0 0 0 15.751 0h-7.5a3.75 3.75 0 0 0-3.75 3.75v16.5A3.75 3.75 0 0 0 8.251 24h7.5a3.75 3.75 0 0 0 3.75-3.75V12zm-14.25 7.5h13.5a.75.75 0 0 0 0-1.5h-13.5a.75.75 0 0 0 0 1.5z"></path>
    </SvgIcon>
  );
};
...
const IconsTemplates = new Map([
  ["egp", "EGP"],
  ["language", <LanguageIcon />],
  ["android", <AndroidIcon />],
  ["loyalty", <LoyaltyIcon />],
  ["listProperty", <ListPropertyIcon />],
  ["customerService", <CustomerServiceIcon />],

  ["partnerDispute", <PartnerDisputeIcon />],
  ["deals", <DealsIcon />],
  ["travelArticles", <TravelArticlesIcon />],
  ["travelCommunities", <TravelCommunitiesIcon />],
  ["about", <AboutIcon />],
  ["careers", <CareersIcon />],
  ["affiliate", <AffiliateIcon />],
  ["pressCentre", <PressCentreIcon />],
  ["privacy", <PrivacyIcon />],
  ["terms", <TermsIcon />],
  ["legal", <LegalIcon />],
]);
                      ...
                      >
                        <ListItemIcon
                          sx={{
                            minWidth: 45,
                            fontSize: 14,
                            color: icon === "egp" ? "#6b6b6b" : "#262626",
                          }}
                        >
                          {IconsTemplates.get(icon)}
                        </ListItemIcon>
                        <ListItemText
                          variant="body2"
                          primary={text}
